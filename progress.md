...
| **Enhancements** | Projector Distance Scanning | **COMPLETED** | `1520387`, `df18324` | Top-to-bottom maximized QR code (taking 94% of screen height) in Fullscreen Projector mode with 3-column widescreen layout (Course info on left, giant QR in center, live roster on right); Flutter mobile scanner with `[1x, 2x, 3x, 5x]` zoom buttons for far-distance scanning. |
